...
class TestGraphTrainerNumerics(unittest.TestCase):
    ...
    def test_qwen3_aot_vs_eager(self):
        self.assertTrue(
            _run_qwen3_loss_compare(test_options_extra="--compile.mode aot"),
        )
    ...
    def test_qwen3_moe_aot_vs_eager(self):
        self.assertTrue(
            _run_qwen3_moe_loss_compare(test_options_extra="--compile.mode aot"),
        )
