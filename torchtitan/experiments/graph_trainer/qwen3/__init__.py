...
def _to_graph_trainer_configs(base_configs):
    """Convert Qwen3Model.Config instances to GraphTrainerQwen3Model.Config."""
    return {
        k: GraphTrainerQwen3Model.Config(
...
_graph_trainer_configs = _to_graph_trainer_configs(qwen3_configs)
